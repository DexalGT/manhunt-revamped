...
execute if score $state mh_enabled matches 3..4 run tellraw @a {"text":"[Manhunt] Already paused. Use /manhunt resume to continue.","color":"gray"}
execute if score $state mh_enabled matches 3..4 run return 0
