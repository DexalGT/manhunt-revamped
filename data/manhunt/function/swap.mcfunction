...
#
# Algorithm:
#  1. Reads the saved runner count from $wanted_runners mh_runner_count.
...
execute unless score $wanted_runners mh_runner_count matches 1.. run scoreboard players set $wanted_runners mh_runner_count 1
